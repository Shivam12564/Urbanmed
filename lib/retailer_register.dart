...
import 'package:urbanmed/shop_register.dart';

// ignore: must_be_immutable
class Retailregister extends StatefulWidget {
  Retailregister({this.uid}) ;
  String? uid;
...
class Rregister extends State<Retailregister> {
  ...
  final retaildatabase =
      FirebaseDatabase.instance.ref().child("Retailer");
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (val) =>
                      val != null && val.isEmpty ? 'Enter your Owner Name' : null,
                    ...
                    TextFormField(
                      ...
                      validator: (val) =>
                      val != null &&  val.isEmpty ? 'Enter your Contact Number' : null,
