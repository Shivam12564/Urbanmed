...
class ViewShopInfo extends StatefulWidget {
  final uid;
  final isComeFromMenu;

  ViewShopInfo(this.uid, this.isComeFromMenu);

  @override
  _ViewShopInfoState createState() => _ViewShopInfoState();
}

class _ViewShopInfoState extends State<ViewShopInfo> {
  ...
  final shopdatabase = FirebaseDatabase.instance.reference().child("Retailer").child("Shopdata");
  String shopname = '';
  String address = '';
  ...
  Future createAlertDialog(BuildContext context) {
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text("Press Yes When You Are Currently At Your Shop Inorder to Get the Proper Location "),
            actions: <Widget>[
              ElevatedButton(
                child: Text('Yes'),
                onPressed: () {
                  Navigator.of(context).pop(addressLatitudeandLongitude.toString());
                },
              )
            ],
          );
