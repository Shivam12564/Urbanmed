...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void getDetails() async {
    query = await FirebaseFirestore.instance.collection('Retailer').where('email', isEqualTo: firebaseUser!.email).get();
    if (query.docs.isNotEmpty) {
      shopID = query.docs[0].id;

      var productquery = await FirebaseFirestore.instance.collection('Retailer').doc(shopID).collection('ProductData').doc(widget.productId).get();
      print(productquery);
      if (productquery.data() != null) {
        ...
        manufacturingdateInputController.text = data['manufacture_date'].toString();
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (val) => val != null && val.isEmpty ? 'Enter your Product Name' : null,
                    ...
                    SizedBox(height: 20.0),
                    TextFormField(
                        decoration: textInputDecoration.copyWith(hintText: 'Medicine Type Like Homeopathy ...'),
                        validator: (val) => val != null && val.isEmpty ? 'Enter the Type of Medicine ' : null,
                    ...
                    SizedBox(height: 20.0),
                    TextFormField(
                        decoration: textInputDecoration.copyWith(hintText: 'Product Manufacturing Date (DD/MM/YYYY)'),
                        validator: (val) => val != null && val.isEmpty ? 'Enter your product manufacturing date' : null,
                        controller: manufacturingdateInputController,
                        onChanged: (val) {
                          setState(() => manufacturingdate = "");
                        }),
                    SizedBox(height: 20.0),
                    TextFormField(
                      decoration: textInputDecoration.copyWith(hintText: 'Product Expiring Date (DD/MM/YYYY)'),
                      validator: (val) => val != null && val.isEmpty ? 'Enter your product expring date' : null,
                    ...
                    SizedBox(height: 20.0),
                    TextFormField(
                      decoration: textInputDecoration.copyWith(hintText: 'Product Cost per unit'),
                      validator: (val) => val != null && val.isEmpty ? 'Enter your product cost per unit' : null,
                    ...
                    SizedBox(height: 20.0),
                    TextFormField(
                      decoration: textInputDecoration.copyWith(hintText: 'Product Company'),
                      validator: (val) => val != null && val.isEmpty ? 'Enter Product Company name' : null,
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            Map<String, dynamic> data = {
                              ...
                              'manufacture_date': manufacturingdateInputController.text,
                            ...
                            try {
                              ...
                              showMyDialog(context, 'Success', 'Product update successfully....');
                            } catch (e) {
                          ...
                          if (_formKey.currentState!.validate()) {
                            try {
                              await FirebaseFirestore.instance
                                  ...
                                  .delete();
                              Navigator.of(context).pop();
                              showMyDialog(context, 'Success', 'Product deleted successfully....');
                            } catch (e) {
                              showMyDialog(context, 'Error!!', e.toString());
                            }
                          } else {
