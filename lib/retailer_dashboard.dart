...
import 'package:urbanmed/product_register.dart';
...
class Dashboard extends State<Ddashboard> {
          ...
          : StreamBuilder<QuerySnapshot>(
              stream: searchcontroller.text.length > 0
                  ? FirebaseFirestore.instance
                      ...
                      .snapshots()
                  : FirebaseFirestore.instance.collection('Retailer').doc(shopID).collection("ProductData").snapshots(),
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: ElevatedButton(
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => ViewShopInfo(User, true),
                                ));
                              },
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          if (_currentPosition != null && _currentAddress != null)
                                            Text(_currentAddress!, style: Theme.of(context).textTheme.bodyText2),
                                        ],
                                      ),
                                    ),
                                    SizedBox(
  ...
  Widget buildcard(element) {
    ...
    return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('Retailer').doc(shopID).collection("ProductData").snapshots(),
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            var docsData = snapshot.data!.docs;
            return SingleChildScrollView(
